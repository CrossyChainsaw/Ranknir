from modules2.get_elo import get_players_elo_1v1, get_players_elo_2v2, get_players_elo_1v1_and_2v2
...
async def clan_console_mix_1v1_elo_list(clan, bot):
    ...
    all_players_array.append(await get_players_elo_1v1(clan, console_players))
    # Get Clan
    clan_data_array = []
    for clan_id in clan.id_array:
        ...
        all_players_array.append(await get_players_elo_1v1(clan, clan_players))
