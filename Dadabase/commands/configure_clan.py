...
async def configure_clan(interaction, clan_names: str, channel_1v1_id:int, channel_2v2_id:int, clan_id:str, color:str, image:str, sorting_method:str, member_count:str, xp:str, no_elo_players:str, channel_rotating_id:int, has_account_linkers:bool):
    clan_names = split_string(clan_names)
    clan_id = split_string(clan_id)
    clan = Clan(interaction.guild.name, clan_names, channel_1v1_id, channel_2v2_id, clan_id, format_color(color), image, str(interaction.guild.id), sorting_method, member_count, xp, no_elo_players, channel_rotating_id, has_account_linkers)
