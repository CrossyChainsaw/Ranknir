...
async def configure_clan_command(interaction, channel_1v1_id:int, channel_2v2_id:int, clan_id:str, color:str,
    ...
    await configure_clan(interaction, channel_1v1_id, channel_2v2_id, clan_id, color, image, 
