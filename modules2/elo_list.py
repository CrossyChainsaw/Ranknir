from modules2.get_elo import get_players_elo_1v1_and_2v2, get_players_elo_1v1_and_2v2_and_rotating
...
async def clan_console_mix_1v1_and_2v2_and_rotating_elo_list(clan, bot):
  ...
  # Get Console Players
  console_players = get_console_players(clan)
  console_player_objects, console_team_objects, console_rotating_objects = await get_players_elo_1v1_and_2v2_and_rotating(clan, console_players) # p1
  all_player_objects_array.append(console_player_objects)
  all_team_objects_array.append(console_team_objects)
  ...
  for clan_id in clan.id_array:
    ...
    clan_players = clan_data['clan']
    clan_player_objects, clan_team_objects, clan_rotating_objects = await get_players_elo_1v1_and_2v2_and_rotating(clan, clan_players) # p2
    all_player_objects_array.append(clan_player_objects)
    all_team_objects_array.append(clan_team_objects)
