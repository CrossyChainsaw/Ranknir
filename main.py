...
from modules.elo_list import clan_console_mix_1v1_elo_list_realbruh, clan_console_mix_1v1_and_2v2_elo_list
...
# Run this command for 1v1 leaderboard (r!1v1)
@bot.command(name='1v1')
@has_permissions(manage_roles=True, ban_members=True)
async def clan_console_mix_1v1_elo_list(ctx):
    await clan_console_mix_1v1_elo_list_realbruh(YOUR_CLAN, bot)
