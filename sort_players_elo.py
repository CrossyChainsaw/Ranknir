...
def sort_players_elo(clan_id):
    ...
    for (current, peak, team_name) in zip (clan_current_2v2_ratings_old, clan_peak_2v2_ratings_old, clan_2v2_teamnames_old):
    ...
    while len(clan_current_2v2_ratings_new) > 0:
        ...
        for (current, peak, teamCurrent) in zip(clan_current_2v2_ratings_new,
                                                clan_peak_2v2_ratings_new,
                                                clan_2v2_teamnames_new):
            index += 1
        ...
        clan_2v2_teamnames_sorted.append(clan_2v2_teamnames_new.pop(bestIndex))
    print('done sorting')
